                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-validation">
                            <form class="form-valide" action="{{ url('/simpan_paket_kiloan') }}" method="post"
                                  name="paket_kiloan_baru_form">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-kode-paket">Kode Paket <span
                                              class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="val-kode-paket" name="kd_paket"
                                               readonly="readonly" value="{{ $max_code }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-nama">Nama Paket <span
                                              class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" id="val-nama" name="nama_paket"
                                               placeholder="Masukkan nama paket">
                                        <div class="nama_paket_error"></div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-harga">Harga Paket <span
                                              class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="val-harga" name="harga_paket"
                                ...
                                <input type="hidden" class="form-control" id="val-hari" name="hari_paket"
                                       placeholder="Masukkan lama hari" min="1" value="1">
                                <input type="hidden" id="val-minimal-berat" name="min_berat_paket"
                                       placeholder="Masukkan minimal berat paket" min="1" value="1">
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-outlet">Outlet <span
                                              class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input" value="1"
                                                       name="antar_jemput_paket">Gratis Antar</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
