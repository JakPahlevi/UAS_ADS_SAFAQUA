                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="text-primary">
                                            {{ date('d M Y', strtotime(\App\Transaksi::min('tgl_bayar'))) . ' - ' . date('d M Y', strtotime(\App\Transaksi::max('tgl_bayar'))) }}
                                        </h4>
                                        <p>Total Pemasukan : <b class="text-dark">Rp.
                                                {{ number_format(\App\Struk::sum('harga_bayar'), 2, ',', '.') }}</b></p>
                                    </div>
                                    <div class="col-md-12">
                                        <hr>
                                    </div>
                                    <div class="col-md-12 mb-2">
                                        <table class="tabel-ket mb-3 text-center" style="width: 100%;">
                                            <tr>
                                            ...
                                            <tbody class="isi_tabel_total">
                                                @foreach ($semua_pelanggan_bayar as $pelanggan)
                                                    <tr>
                                                        ...
                                                        <td class="status_total text-center" style="font-size: 14px;"></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="text-primary">
                                            {{ date('d M Y', strtotime(\App\Transaksi::min('tgl_pemberian'))) . ' - ' . date('d M Y', strtotime(\App\Transaksi::max('tgl_pemberian'))) }}
                                        </h4>
                                        <p>Jumlah Pelanggan : <b class="text-dark">{{ \App\Transaksi::all()->count() }}</b>
                                        </p>
                                    </div>
                                            ...
                                            <tbody class="isi_tabel_jumlah">
                                                @foreach ($semua_pelanggan_harian as $pelanggan)
                                                    <tr>
                                                        ...
                                                        @php
                                                            $jumlah_pelanggan = \App\Transaksi::where('tgl_pemberian', $pelanggan->tgl_pemberian)->count();
                                                        @endphp
                                                        <td class="jumlah_hari font-weight-bold text-center">
                                                            {{ $jumlah_pelanggan }}</td>
                                                        <td class="status_jumlah text-center" style="font-size: 14px;"></td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-1">
                        <div class="card-body">
                            ...
                            <span class="display-5 float-right opacity-5"><i class="fa fa-user"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-4">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                ...
                                <p class="mb-0 text-white">Jumlah Selesai</p>
                            </div>
                            <span class="display-5 float-right opacity-5"><i class="fa fa-list-alt"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-9">
                        <div class="card-body">
                            ...
                            <span class="display-5 float-right opacity-5"><i class="fa fa-users"></i></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="card gradient-8">
                        <div class="card-body">
                            ...
                            <div class="d-inline-block">
                                ...
                                <p class="mb-0 text-white">Jumlah Outlet</p>
                            </div>
                            <span class="display-5 float-right opacity-5"><i class="fa fa-building-o"></i></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card" style="background-color: #dcdbfd;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <h4 class="text-primary mt-4 ml-5">Selamat Datang {{ auth()->user()->name }}!</h4>
                                    <p class="text-dark ml-5 mt-4" style="font-weight: 500;">Nikmati Kemudahan Memesan
                                    ...
                                    <form method="POST" class="form_edit_identitas" enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex justify-content-between" style="margin-bottom: -10px;">
                                            ...
                                            <div class="edit-profil-button" style="margin-top: -10px;">
                                                <button type="button" style="border: 0px; background-color: #fff;"
                                                        class="btn text-primary edit_identitas_btn"><i
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="btn btn-sm font-weight-bold mt-1"
                                                 style="background-color: #6fd96f; color: #fff;">
                                                {{ auth()->user()->role }}</div>
                                        </div>
                                        <table class="table_profil mt-3" style="width: 100%;">
                                            ...
                                            <tr class="align-top">
                                                ...
                                                <td class="input_ubah" hidden=""><input required=""
                                                           type="text" name="ubah_no_hp_pelanggan"
                                                           class="number_input" value="{{ $no_hp->no_hp_pelanggan }}">
                                                </td>
                                            </tr>
                                            <tr class="align-top">
                                                <th>Alamat</th>
