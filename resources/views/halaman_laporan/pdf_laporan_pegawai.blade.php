    ...
    <div class="header">
        <table style="width: 100%;" class="table-header">
            ...
            <tr>
                ...
                <td style="font-size: 28px; color: #313131; padding-top: 15px; padding-right: 50px;" class="text-right">
                    Invoice</td>
            </tr>
            <tr>
    ...
    <div class="body-content">
        <table style="width: 100%; border-collapse: collapse; padding-right: 50px; padding-left: 50px;"
            ...
            <tr>
                ...
                <th style="padding-top: 10px; padding-bottom: 10px; text-align: right; color: #7572f7;">
                    {{ $riwayats->count() }}</th>
            </tr>
        </table>
    </div>
